...
not decode to a point on the prime subgroup \(\bold{G}\).
...
A point with unknown discrete logarithm. Its derivation MUST be
documented to ensure no party knows the discrete log of \(B\) relative
to \(G\).
...
\item
  ...
  with input the string: \texttt{"ring-proof-pad"}.
\item
